...
export default function App() {
  return (
    <Box display="flex" flexDirection="column" gap={4}>
      <Box>
        <Text size="sm" weight="semibold" mb={2}>With visible label</Text>
        <Box display="flex" alignItems="center" gap={2}>
          <Checkbox id="visible" />
      ...
      <Box>
        <Text size="sm" weight="semibold" mb={2}>With aria-label</Text>
      ...
      <Box>
        <Text size="sm" weight="semibold" mb={2}>With description</Text>
        <Box display="flex" alignItems="start" gap={2}>
          <Checkbox id="described" aria-describedby="desc" mt={1} />
          <Box>
            <Text as="label" htmlFor="described" display="block">
              Enable feature
            </Text>
