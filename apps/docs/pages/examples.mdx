...
export default function App() {
  ...
  return (
    <Box maxWidth="400px" p={6} backgroundColor="secondary" borderRadius="lg">
      <Text as="h2" size="2xl" weight="bold" mb={6}>
        Sign In
      </Text>
...
A responsive dashboard layout using Box components.
...
export default function App() {
  ...
  return (
    <Box p={6}>
      ...
      {/* Content Area */}
      <Box display="flex" gap={6} flexDirection={{ mobile: 'column', tablet: 'row' }}>
        {/* Main Content */}
